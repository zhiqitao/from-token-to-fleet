...
!{[}\hyperref[fig:8.1]{Fig 8.1} --- Prefill above the ridge (compute-bound), decode below it
(memory-bound). H100 (solid) vs H200 (dashed) ridge points from vendor
datasheets (989 TFLOPS, 3.35 / 4.8 TB/s); Continuous-Batching arrow
shows decode climbing the slope as batch grows
\href{figures/fig-08-0801.pdf}{2° DERIVED; H100/H200 peaks {[}1P: vendor
datasheet{]}}
